            ...
            if (uph.getText().toString().isEmpty())
              {
               ...
               passok.setError("enter a avlid phone  password");
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://androidprojectstechsays.000webhostapp.com/C_traker/parent_login.php",
...
//                                Toast.makeText(Signin.this, response, Toast.LENGTH_LONG).show();
                                if (response.contains("success")) {
                                    ...
                                    SharedPreferences sh=getSharedPreferences("data11",MODE_PRIVATE);
